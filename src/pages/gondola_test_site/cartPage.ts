...
export class CartPage {
    ...
    @action("check payment button disabled", "Check whether Payment button is disabled or not.")
    public async checkPaymentButtonDisabled() {
    ...
    public async fillPaymentInfo(payment: Payment) {
        await gondola.waitForElement(this.txtPaymentEmail);
